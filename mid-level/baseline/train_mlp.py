...
class MLP(torch.nn.Module):
    def __init__(self, input_dim, output_dim):
        ...
        self.hidden1 = torch.nn.Linear(input_dim, 26)
        self.hidden2 = torch.nn.Linear(26, 18)
        self.hidden3 = torch.nn.Linear(18, 12)
        self.output = torch.nn.Linear(12, output_dim)
